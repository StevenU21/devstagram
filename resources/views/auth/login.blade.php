...
<div class="h-screen md:flex">
    <div class="relative overflow-hidden md:flex w-1/2 bg-gradient-to-tr from-blue-800 to-purple-700 i justify-around items-center hidden">
        <div>
            ...
            <a
                href={{ route('register') }}
                class="block w-28 bg-white text-indigo-800 mt-4 py-2 rounded-2xl font-bold mb-2 text-center"
            >
                Register
            </a>
        </div>
        ...
        <form class="bg-white max-sm:pt-16 w-full max-w-[20rem]" action="{{ 'login' }}" method="POST">
            ...
            <div class="flex items-center border-2 py-2 px-3 rounded-2xl mt-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" >
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0" />
                </svg>
                <input
                    class="pl-2 outline-none border-none flex-1"
                    type="text"
                    name="email"
                    id=""
            ...
            <div class="flex items-center py-2 gap-2">
                <input
                    class="p-2 outline-none border-none"
                    type="checkbox"
                    name="remember"
                    id="remember"
                    placeholder="Password"
