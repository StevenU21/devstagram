...
<form id="dropzone" enctype="multipart/form-data" class="bg-white shadow rounded-lg mb-6 p-4" action="{{ route('post.create') }}" method="POST">
    @csrf
    <textarea name="post"  placeholder="Type something... and drag and drop." class="w-full rounded-lg p-2 text-sm bg-gray-100 border border-transparent appearance-none rounded-tg placeholder-gray-400"></textarea>
