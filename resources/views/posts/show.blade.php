...
@endsection
@section('content')
    <div class="bg-white shadow rounded-lg mb-6 max-w-xl mx-auto">
        <div class="flex flex-row px-2 py-3 mx-3">
            ...
            <div class="flex flex-col mb-2 ml-4 mt-1">
                <div class="text-gray-600 text-sm font-semibold">{{ $post->user->username }}</div>
        ...
        <div class="text-black p-4 antialiased flex">
            ...
            <div>
                <div class="bg-gray-100 rounded-lg px-4 pt-2 pb-2.5">
                    <div class="text-gray-600 text-sm font-semibold">Sofi</div>
                ...
                <div class="bg-white border border-white rounded-full float-right -mt-8 mr-0.5 flex shadow items-center ">
                    ...
                    <svg class="p-0.5 h-5 w-5 rounded-full -ml-1.5 bg-white" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 16">
                        <defs>
