...
@section('content')
    ...
    <div class="bg-gray-100">
        ...
        <main class="grid grid-cols-1 lg:grid-cols-2 gap-6 pt-5 mx-12 w-2xl container px-2">
            ...
            <article class="">
                        ...
                        <div class="bg-white shadow rounded-lg mb-6">
                            <div class="flex flex-row px-2 py-3 mx-3">
                                ...
                                <div class="flex flex-col mb-2 ml-4 mt-1">
                                    <div class="text-gray-600 text-sm font-semibold">{{ $user->username }}</div>
                            ...
                            <div class="text-gray-400 font-medium text-sm mb-7 mt-6 mx-3 px-2 ">
                                <img class="h-full w-full object-cover rounded-xl"
                                    src="{{ asset('uploads') . '/' . $post->image }}" alt="">
                            </div>
                                ...
                                <div>
                                    ...
                                    <div
                                        ...
                                        <svg class="p-0.5 h-5 w-5 rounded-full -ml-1.5 bg-white"
                                            ...
                                            viewBox="0 0 16 16">
                                            <defs>
                                                <linearGradient id="a2" x1="50%" x2="50%"
                                                    y1="0%" y2="100%">
                            ...
                            @auth
                                <form action="{{ route('comments.store', ['user' => $user, 'post' => $post->id]) }}"
                                    method='POST'
                                    ...
                                    <input type="search"
                                        class="w-full flex-1 py-2 pl-4 pr-10 text-sm bg-gray-100 border border-transparent appearance-none rounded-tg placeholder-gray-400"
                ...
                {{-- <div class="bg-white shadow rounded-lg mb-6">
                    <div class="flex flex-row px-2 py-3 mx-3">
                        ...
                        <div class="flex flex-col mb-2 ml-4 mt-1">
                            <div class="text-gray-600 text-sm font-semibold">{{ $post->username }}</div>
                            <div class="flex w-full mt-1">
                                <div class="text-blue-700 font-base text-xs mr-1 cursor-pointer">
                                    SEO
                                </div>
                    ...
                    <div class="flex w-full border-t border-gray-100">
                        <div class="mt-3 mx-5 flex flex-row text-xs">
                            ...
                            <div class="flex text-gray-700 font-normal rounded-md mb-2 mr-4 items-center">Views: <div
                                    class="ml-1 text-gray-400 text-ms"> 60k</div>
                            </div>
                        </div>
                        <div class="mt-3 mx-5 w-full flex justify-end text-xs">
                            <div class="flex text-gray-700  rounded-md mb-2 mr-4 items-center">Likes: <div
                    ...
                    <div class="text-black p-4 antialiased flex">
                        ...
                        <div>
                            <div class="bg-gray-100 rounded-lg px-4 pt-2 pb-2.5">
                                <div class="text-gray-600 text-sm font-semibold">{{ $user->username }}</div>
                                <div class="text-xs leading-snug md:leading-normal">Lorem ipsum dolor sit amet, consectetur
                            ...
                            <div
                                class="bg-white border border-white rounded-full float-right -mt-8 mr-0.5 flex shadow items-center ">
                                <svg class="p-0.5 h-5 w-5 rounded-full z-20 bg-white" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <svg class="p-0.5 h-5 w-5 rounded-full -ml-1.5 bg-white"
                                    ...
                                    viewBox="0 0 16 16">
                                    <defs>
                                        <linearGradient id="a2" x1="50%" x2="50%" y1="0%"
                                            y2="100%">
                                            <stop offset="0%" stop-color="#FF6680"></stop>
                                            <stop offset="100%" stop-color="#E61739"></stop>
                                        </linearGradient>
                ...
                {{-- <div class="bg-white shadow rounded-lg">
                    ...
                    <div class="text-gray-600 font-semibold  mb-2 mx-3 px-2">Dummy text of the printing and typesetting
                        industry</div>
                    <div class="text-gray-500 text-sm mb-6 mx-3 px-2">Lorem Ipsum is simply dummy text of the printing and
                        typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500
                    </div>
