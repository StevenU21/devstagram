        ...
        <header class="p-5 border-b shadow w-screen sticky z-[100] bg-white flex top-0">
            <nav class="bg-white w-full flex relative justify-between items-center px-8">
                ...
                <div class="relative hidden sm:block flex-shrink flex-grow-0">
                    <input type="text" class="bg-purple-white bg-gray-100 rounded-lg border-0 p-3 w-full" placeholder="Search something..." style="min-width:400px;">
                ...
                <div class="flex items-center justify-center gap-4">
                        <div class="block relative">
                            <form action="{{ route('logout') }}"  method="POST">
                                @csrf
                                <button type="submit" class="inline-block py-2 px-3 hover:bg-gray-200 rounded-full relative ">
