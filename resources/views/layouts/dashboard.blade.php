            ...
            <aside class="space-y-4">
                <x-card>
                    <x-card-content class="flex flex-col items-center justify-center">
                        ...
                        <div
                            class="text-sm leading-normal text-blue-600 flex justify-center items-center font-semibold text-center">
                            {{ strtoupper($user->role) }}
                        </div>

                        <div class="text-sm leading-normal text-gray-400 flex justify-center items-center text-center">
